# 三百六十、公司-2019 校招笔试-ios 开发工程师客观题合集
...
oc 中，property 对应实例变量及其 set，get 方法，节省了代码
...
字符串属性使用 copy 更安全，这个带有主观性。而字符串可以直接赋值，可以使用 assign,这个是可以的。只不过用 assign 修饰的变量没有被加入引用计数而已。这道题出得不太严谨!
